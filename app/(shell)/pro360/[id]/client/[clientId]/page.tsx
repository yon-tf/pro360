              ...
              {(() => {
                ...
                return (
                  <>
                    ...
                    {missing > 0 && <Badge variant="destructive" className="px-2 py-0 text-xxxs">{missing} missing</Badge>}
                    {late > 0 && <Badge variant="secondary" className="px-2 py-0 text-xxxs">{late} late</Badge>}
                  </>
                );
              })()}
            </div>
