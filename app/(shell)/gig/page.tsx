...
const STATUS_STYLES: Record<GigJobStatus, string> = {
  open: "bg-success/15 text-success border-0",
      ...
      <CardContent className="flex flex-1 flex-col gap-4 p-5">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          {job.claimableExpenses && (
            <span className="inline-flex rounded-full border border-warning/35 bg-warning/12 px-3 py-1 text-xs font-medium text-warning">
              Claimable Expenses
            </span>
          )}
        </div>
