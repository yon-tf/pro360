...
export const mockTFPRows: TFPProfessionalRow[] = [
  ...
  },
  {
    ...
    roles: [],
    tfpPlusQualified: false,
    chat: { tfpTime: 7, clientTime: 5, earnings: 240 },
    therapy: { videoCount: 5, f2fCount: 2, earnings: 210 },
    referrals: { tfpReferral: 0, userReferral: 0, earnings: 0 },
    eventsEngagements: { clinicalEvents: 1, csEngagements: 0, earnings: 40 },
    leadership: { podLeaderEarnings: 0, otLdpEarnings: 0 },
    bonuses: { languageBonus: 0, otherAdjustments: 0 },
  ...
  },
  {
    ...
    roles: [],
    tfpPlusQualified: true,
    chat: { tfpTime: 11, clientTime: 7, earnings: 360 },
    therapy: { videoCount: 7, f2fCount: 3, earnings: 310 },
    referrals: { tfpReferral: 1, userReferral: 1, earnings: 75 },
    eventsEngagements: { clinicalEvents: 2, csEngagements: 1, earnings: 120 },
    leadership: { podLeaderEarnings: 0, otLdpEarnings: 0 },
    bonuses: { languageBonus: 50, otherAdjustments: 0 },
    reconciliation: 0,
  ...
  },
  {
    ...
    roles: [],
    tfpPlusQualified: false,
    chat: { tfpTime: 5, clientTime: 3, earnings: 160 },
    therapy: { videoCount: 3, f2fCount: 1, earnings: 120 },
    referrals: { tfpReferral: 0, userReferral: 0, earnings: 0 },
    eventsEngagements: { clinicalEvents: 0, csEngagements: 1, earnings: 40 },
    leadership: { podLeaderEarnings: 0, otLdpEarnings: 0 },
    bonuses: { languageBonus: 0, otherAdjustments: 0 },
    reconciliation: 0,
    total: 320,
  ...
  },
  {
    ...
    roles: [],
    tfpPlusQualified: true,
    chat: { tfpTime: 9, clientTime: 6, earnings: 300 },
    therapy: { videoCount: 6, f2fCount: 2, earnings: 240 },
    referrals: { tfpReferral: 0, userReferral: 1, earnings: 25 },
    eventsEngagements: { clinicalEvents: 1, csEngagements: 1, earnings: 80 },
    leadership: { podLeaderEarnings: 0, otLdpEarnings: 0 },
    bonuses: { languageBonus: 0, otherAdjustments: 30 },
    reconciliation: 0,
    total: 675,
    status: "Ready",
    reviewer: "Anton Kraskov",
  },
  {
    ...
    roles: ["Pod Leader"],
    tfpPlusQualified: true,
    chat: { tfpTime: 14, clientTime: 9, earnings: 460 },
    therapy: { videoCount: 9, f2fCount: 5, earnings: 420 },
    referrals: { tfpReferral: 2, userReferral: 1, earnings: 125 },
    eventsEngagements: { clinicalEvents: 3, csEngagements: 2, earnings: 200 },
    leadership: { podLeaderEarnings: 250, otLdpEarnings: 0 },
    bonuses: { languageBonus: 50, otherAdjustments: 0 },
    reconciliation: 0,
    total: 1505,
    status: "Ready",
  ...
  },
  {
    ...
    roles: [],
    tfpPlusQualified: false,
    chat: { tfpTime: 6, clientTime: 4, earnings: 200 },
    therapy: { videoCount: 4, f2fCount: 2, earnings: 180 },
    referrals: { tfpReferral: 0, userReferral: 0, earnings: 0 },
    eventsEngagements: { clinicalEvents: 1, csEngagements: 0, earnings: 40 },
    leadership: { podLeaderEarnings: 0, otLdpEarnings: 0 },
    bonuses: { languageBonus: 0, otherAdjustments: 0 },
  ...
  },
  {
    ...
    roles: [],
    tfpPlusQualified: true,
    chat: { tfpTime: 10, clientTime: 7, earnings: 340 },
    therapy: { videoCount: 7, f2fCount: 3, earnings: 300 },
    referrals: { tfpReferral: 1, userReferral: 0, earnings: 50 },
    eventsEngagements: { clinicalEvents: 2, csEngagements: 1, earnings: 120 },
    leadership: { podLeaderEarnings: 0, otLdpEarnings: 100 },
    bonuses: { languageBonus: 0, otherAdjustments: 0 },
  ...
  },
  {
    ...
    roles: [],
    tfpPlusQualified: false,
    chat: { tfpTime: 4, clientTime: 2, earnings: 120 },
    therapy: { videoCount: 2, f2fCount: 1, earnings: 90 },
    referrals: { tfpReferral: 0, userReferral: 0, earnings: 0 },
    eventsEngagements: { clinicalEvents: 0, csEngagements: 0, earnings: 0 },
    leadership: { podLeaderEarnings: 0, otLdpEarnings: 0 },
    bonuses: { languageBonus: 0, otherAdjustments: 0 },
...
export const mockExceptions: PayoutException[] = [
  ...
  { id: "e3", reason: "Unclaimed payout — no response", professionalId: "p5", professionalName: "Michael Tan", owner: null, status: "Open", category: "unclaimed" },
  ...
  { id: "e6", reason: "Minor delta within tolerance", professionalId: "p6", professionalName: "Emily Chen", owner: "Anton Kraskov", status: "Resolved", category: "flagged_delta" },
  { id: "e7", reason: "FX rate confirmed by finance", professionalId: "p7", professionalName: "Alex Ng", owner: null, status: "Resolved", category: "fx_recon" },
];
