    ...
    >
      ...
      <div className="flex items-center justify-between gap-2">
          ...
          {icon && (
            <div
              className={cn(
                ...
                isPrimary ? "bg-primary-foreground/20 text-primary-foreground" : "bg-muted/60 text-muted-foreground",
              )}
            >
              {icon}
            </div>
        ...
        {progress ? (
          ...
          <span className={cn("flex shrink-0 items-center gap-1 font-medium tabular-nums leading-none", isPrimary ? "text-primary-foreground/90" : TREND_STYLE[trendDirection])}>
      ...
      <div className="mt-auto">
        <div className="flex flex-wrap items-baseline gap-x-2 gap-y-1">
          ...
          {target && (
            <span
              className={cn(
                "inline-flex h-5 items-center self-center rounded-full px-2 text-micro font-medium leading-none whitespace-nowrap",
                isPrimary
